...
fn caesar_crack (word:&str, list:&str) {
    ...
    let poss:[&str; 26] = [&caesar(&word,0),&caesar(&word,25),&caesar(&word,24),&caesar(&word,23),&caesar(&word,22),&caesar(&word,21),&caesar(&word,20),&caesar(&word,19),&caesar(&word,18),&caesar(&word,17),&caesar(&word,16),&caesar(&word,15),&caesar(&word,14),&caesar(&word,13),&caesar(&word,12),&caesar(&word,11),&caesar(&word,10),&caesar(&word,9),&caesar(&word,8),&caesar(&word,7),&caesar(&word,6),&caesar(&word,5),&caesar(&word,4),&caesar(&word,3),&caesar(&word,2),&caesar(&word,1)];
    let i = i.1.unwrap();
